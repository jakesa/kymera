...
client = Kymera::Client.new('tcp://127.0.0.1:5550','tcp://127.0.0.1:5556', 'tcp://127.0.0.1:6000')
client.run_tests('c:/apollo/source/integration_tests/features/posting', 'cucumber', ['-p default'])